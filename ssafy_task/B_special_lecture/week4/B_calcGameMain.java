...
class B_CalcGameMain {
    private static BufferedReader br;
    private static B_calcGame B_calcGame = new B_calcGame();
    ...
    private static boolean run() throws Exception {
        ...
        for (int q = 0; q < query_num; q++) {
            ...
            if (query == CMD_INIT) {
                ...
                ret = B_calcGame.findNumber(num, Nth, ret_numbers);
                if (ans != ret) {
                    ok = false;
                }
                if (ans == 1) {
